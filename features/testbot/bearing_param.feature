...
Feature: Bearing parameter
    ...
    Scenario: Testbot - Initial bearing in all direction
        ...
        When I route I should get
            | from | to | bearings | route                         | bearing                                                               |
            | 0    | q  | 0 90     | ia,ab,bc,cd,de,fg,gh,ha,ha    | 0->0,0->90,90->180,180->180,180->270,270->0,0->0,0->90,90->0          |
            | 0    | a  | 45 90    | jb,bc,cd,de,fg,gh,ha,ha       | 0->45,45->180,180->180,180->270,270->0,0->0,0->90,90->0               |
            | 0    | q  | 90 90    | kc,cd,de,fg,gh,ha,ha          | 0->90,90->180,180->270,270->0,0->0,0->90,90->0                        |
            | 0    | a  | 135 90   | ld,de,fg,gh,ha,ha             | 0->135,135->270,270->0,0->0,0->90,90->0                               |
            | 0    | a  | 180 90   | me,fg,gh,ha,ha                | 0->180,180->270,0->0,0->90,90->0                                      |
